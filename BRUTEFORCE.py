...
def PlusCourtChemin(pt):
    """Fonction qui renvoie la combinaison du pcc, la distance puis le nombre de combinaisons
    ...
    plt.show()
    return(dist_enregistre,choix_enregistre,compteur)
...
#print(points)
#
##points=((-9, 4), (10, 6), (-9, -2), (1, -8), (-2, 9))
#pcc=PlusCourtChemin(points)
#print("Plus courte distance et combinaison liee a ceci: ",pcc[0],pcc[1])
#print("nombre de combinaison:",pcc[2])
